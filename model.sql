...
(
  ...
  CD_STATUS NUMBER(2) NOT NULL,
  CD_PRESTADOR NUMBER(*) NOT NULL,
  SN_OPME VARCHAR2(1) NOT NULL,
  SN_MATERIAL VARCHAR2(1) NOT NULL,
  DT_EMISSAO DATE NOT NULL,
  DT_ALTERACAO DATE NOT NULL,
  CD_STATUS_OPME NUMBER(2),
  CD_STATUS_MAT NUMBER(2),
  DT_ENTREGA DATE,
  DT_RESPOSTA DATE,
  CD_GUIA VARCHAR2(20),
...
CREATE TABLE USRDBVAH.TB_SISPAG_IT_OPME
(
  ID NUMBER(*) PRIMARY KEY NOT NULL,
  ID_GUIA NUMBER(*) NOT NULL,
  VL_QUANTIDADE INTEGER NOT NULL,
  NM_NOME VARCHAR2(150),
  CONSTRAINT TB_SISPAG_IT_OPME_FK1 FOREIGN KEY (ID_GUIA) REFERENCES USRDBVAH.TB_SISPAG_GUIA (ID)
);

CREATE SEQUENCE USRDBVAH.SEQ_SISPAG_IT_OPME;

-- ITEM GUIA

CREATE TABLE USRDBVAH.TB_SISPAG_IT_MAT
(
  ID NUMBER(*) PRIMARY KEY NOT NULL,
  ID_GUIA NUMBER(*) NOT NULL,
  VL_QUANTIDADE INTEGER NOT NULL,
  NM_NOME VARCHAR2(150),
  CONSTRAINT TB_SISPAG_IT_MAT_FK1 FOREIGN KEY (ID_GUIA) REFERENCES USRDBVAH.TB_SISPAG_GUIA (ID)
);

CREATE SEQUENCE USRDBVAH.SEQ_SISPAG_IT_MAT;
...
(
  ...
  CONSTRAINT TB_SISPAG_ANEXO_FK1 FOREIGN KEY (ID_GUIA) REFERENCES USRDBVAH.TB_SISPAG_GUIA (ID)
);
...
DROP TABLE USRDBVAH.TB_SISPAG_IT_MAT;
DROP TABLE USRDBVAH.TB_SISPAG_IT_OPME;
...
DROP SEQUENCE USRDBVAH.SEQ_SISPAG_IT_OPME;
DROP SEQUENCE USRDBVAH.SEQ_SISPAG_IT_MAT;
